...
import 'package:flutter_inappwebview_plus_platform_interface/flutter_inappwebview_plus_platform_interface.dart';
...
(function() {
  ...
  Future<String> get tRexRunnerHtml async => await rootBundle.loadString(
      'packages/flutter_inappwebview_plus/assets/t_rex_runner/t-rex.html');

  @override
  Future<String> get tRexRunnerCss async => await rootBundle.loadString(
      'packages/flutter_inappwebview_plus/assets/t_rex_runner/t-rex.css');
