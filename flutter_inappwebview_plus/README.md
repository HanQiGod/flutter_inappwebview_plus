...
[![flutter_inappwebview_plus version](https://img.shields.io/pub/v/flutter_inappwebview_plus?include_prereleases)](https://pub.dartlang.org/packages/flutter_inappwebview_plus)
[![Pub Points](https://img.shields.io/pub/points/flutter_inappwebview_plus)](https://pub.dev/packages/flutter_inappwebview_plus/score)
[![Pub Popularity](https://img.shields.io/pub/popularity/flutter_inappwebview_plus)](https://pub.dev/packages/flutter_inappwebview_plus/score)
[![Pub Likes](https://img.shields.io/pub/likes/flutter_inappwebview_plus)](https://pub.dev/packages/flutter_inappwebview_plus/score)
...
[![flutter_inappwebview_plus_platform_interface version](https://img.shields.io/pub/v/flutter_inappwebview_plus_platform_interface?include_prereleases&label=Platform%20Interface)](https://pub.dartlang.org/packages/flutter_inappwebview_plus_platform_interface)
[![flutter_inappwebview_plus_android version](https://img.shields.io/pub/v/flutter_inappwebview_plus_android?include_prereleases&label=Android)](https://pub.dartlang.org/packages/flutter_inappwebview_plus_android)
[![flutter_inappwebview_plus_ios version](https://img.shields.io/pub/v/flutter_inappwebview_plus_ios?include_prereleases&label=iOS)](https://pub.dartlang.org/packages/flutter_inappwebview_plus_ios)
[![flutter_inappwebview_plus_macos version](https://img.shields.io/pub/v/flutter_inappwebview_plus_macos?include_prereleases&label=macOS)](https://pub.dartlang.org/packages/flutter_inappwebview_plus_macos)
[![flutter_inappwebview_plus_windows version](https://img.shields.io/pub/v/flutter_inappwebview_plus_windows?include_prereleases&label=Windows)](https://pub.dartlang.org/packages/flutter_inappwebview_plus_windows)
[![flutter_inappwebview_plus_web version](https://img.shields.io/pub/v/flutter_inappwebview_plus_web?include_prereleases&label=Web)](https://pub.dartlang.org/packages/flutter_inappwebview_plus_web)
...
- Read the online [API Reference](https://pub.dartlang.org/documentation/flutter_inappwebview_plus/latest/) to get the **full API documentation**.
...
- Check the [flutter_inappwebview_plus/example/integration_test/webview_flutter_test.dart](https://github.com/pichillilorenzo/flutter_inappwebview/blob/master/flutter_inappwebview_plus/example/integration_test/webview_flutter_test.dart) file for other code examples
- [Flutter Browser App](https://github.com/pichillilorenzo/flutter_browser_app): A Full-Featured Mobile Browser App (such as the Google Chrome mobile browser) created using Flutter and the features offered by the flutter_inappwebview_plus plugin
...
Add `flutter_inappwebview_plus` as a [dependency in your pubspec.yaml file](https://flutter.io/using-packages/).
