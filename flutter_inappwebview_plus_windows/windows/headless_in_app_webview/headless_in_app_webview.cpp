...
namespace flutter_inappwebview_plugin
{
  ...
  HeadlessInAppWebView::HeadlessInAppWebView(const FlutterInappwebviewPlusWindowsPlugin* plugin, const HeadlessInAppWebViewCreationParams& params, const HWND parentWindow, std::unique_ptr<InAppWebView> webView)
