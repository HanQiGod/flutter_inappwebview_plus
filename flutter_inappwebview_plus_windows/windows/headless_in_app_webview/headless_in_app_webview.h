...
namespace flutter_inappwebview_plugin
{
  ...
  public:
    ...
    HeadlessInAppWebView(const FlutterInappwebviewPlusWindowsPlugin* plugin, const HeadlessInAppWebViewCreationParams& params, const HWND parentWindow, std::unique_ptr<InAppWebView> webView);
