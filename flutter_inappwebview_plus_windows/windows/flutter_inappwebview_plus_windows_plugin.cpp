...
{
  // static
  void FlutterInappwebviewPlusWindowsPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows* registrar)
  {
    auto plugin = std::make_unique<FlutterInappwebviewPlusWindowsPlugin>(registrar);
    registrar->AddPlugin(std::move(plugin));
  }

  FlutterInappwebviewPlusWindowsPlugin::FlutterInappwebviewPlusWindowsPlugin(flutter::PluginRegistrarWindows* registrar)
    : registrar(registrar)
  {
  ...
  FlutterInappwebviewPlusWindowsPlugin::~FlutterInappwebviewPlusWindowsPlugin()
  {
