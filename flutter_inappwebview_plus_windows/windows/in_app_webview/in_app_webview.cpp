...
namespace flutter_inappwebview_plugin
{
  ...
  InAppWebView::InAppWebView(const FlutterInappwebviewPlusWindowsPlugin* plugin, const InAppWebViewCreationParams& params, const HWND parentWindow, wil::com_ptr<ICoreWebView2Environment> webViewEnv,
  ...
  InAppWebView::InAppWebView(InAppBrowser* inAppBrowser, const FlutterInappwebviewPlusWindowsPlugin* plugin, const InAppWebViewCreationParams& params, const HWND parentWindow, wil::com_ptr<ICoreWebView2Environment> webViewEnv,
    wil::com_ptr<ICoreWebView2Controller> webViewController,
    wil::com_ptr<ICoreWebView2CompositionController> webViewCompositionController)
