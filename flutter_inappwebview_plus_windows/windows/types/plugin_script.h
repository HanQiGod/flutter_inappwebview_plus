#ifndef FLUTTER_INAPPWEBVIEW_PLUS_PLUGIN_PLUGIN_SCRIPT_H_
#define FLUTTER_INAPPWEBVIEW_PLUS_PLUGIN_PLUGIN_SCRIPT_H_
...
#endif //FLUTTER_INAPPWEBVIEW_PLUS_PLUGIN_PLUGIN_SCRIPT_H_